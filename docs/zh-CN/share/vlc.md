...
> 基础URL: `http://127.0.0.1:8080/requests/status.xml`

| 作用         | 参数                        | 备注                                                                                |
| ------------ | --------------------------- | ----------------------------------------------------------------------------------- |
| 播放&暂停    | `command=pl_pause`          |
| 停止         | `command=pl_stop`           |
| 打开播放列表 | `command=pl_play&id=3`      |
| 播放视频     | `command=in_play&input=url` | Special Character Encoding URIComponent<br/>Encoding`input=encodeURIComponent(url)` |
